    ...
    <section className="w-full bg-surface-50 px-6 py-16">
      <div className="mx-auto flex max-w-6xl flex-col">
        <div className="flex max-w-3xl flex-col items-start text-left lg:mx-auto lg:items-center lg:text-center">
          <span className="inline-block px-4 py-1 text-caption font-semibold uppercase tracking-wider text-accent-purple bg-surface-50 border border-accent-purple/40 mb-3 rounded-sm">
            Coming Soon
          </span>
