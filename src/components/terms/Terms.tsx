  ...
  return (
    <section className="w-full bg-surface-50 px-6 py-16">
      <div className="mx-auto flex max-w-3xl flex-col">
        <h1 className="font-display text-display-lg font-semibold leading-tight tracking-tight text-text-primary-light">
          Terms of Service
        </h1>

        <div className="mt-8 flex flex-col gap-6 text-body-sm leading-relaxed text-text-secondary-light [&_a]:text-accent-magenta [&_a]:underline [&_a]:underline-offset-2">
          <p>
          ...
          <h2 className="font-display text-display-sm font-semibold text-text-primary-light">Notice to Parents</h2>
          <p>
            OUR SITE IS NOT INTENDED FOR ANY CHILDREN UNDER THE AGE OF 18. WE HAVE IMPLEMENTED REASONABLE METHODS TO RESTRICT THE ABILITY OF CHILDREN UNDER 18 TO ACCESS OUR SITE. WE URGE YOU TO MONITOR AND SUPERVISE YOUR CHILDREN&apos;S INTERNET ACTIVITIES. IF YOU ARE THE PARENT OR GUARDIAN AND BELIEVE YOUR CHILD HAS PROVIDED US WITH PERSONAL INFORMATION, PLEASE CONTACT US AT <a href="mailto:support@novaecho.ai">support@novaecho.ai</a> TO REQUEST DELETION.
          </p>

          <h2 className="font-display text-display-sm font-semibold text-text-primary-light">Agreement</h2>
          <p>
          ...
          <h2 className="font-display text-display-sm font-semibold text-text-primary-light">Privacy</h2>
          <p>
            We care about data privacy and security. Please review our <a href="/privacy">Privacy Policy</a>. By using the Site, you agree to be bound by our Privacy Policy, which is incorporated into these Terms of Service. Please be advised the Site is hosted in the United States. If you access the Site from any other region of the world with laws or other requirements governing personal data collection, use, or disclosure that differ from applicable laws in the United States, then through your continued use of the Site, you are transferring your data to the United States, and you agree to have your data transferred to and processed in the United States.
          </p>

          <h2 className="font-display text-display-sm font-semibold text-text-primary-light">Intellectual Property Rights</h2>
          <p>
          ...
          <h2 className="font-display text-display-sm font-semibold text-text-primary-light">Site Management</h2>
          <p>
          ...
          <h2 className="font-display text-display-sm font-semibold text-text-primary-light">Modifications and Interruptions</h2>
          <p>
          ...
          <h2 className="font-display text-display-sm font-semibold text-text-primary-light">Errors, Inaccuracies, and Omissions</h2>
          <p>
          ...
          <h2 className="font-display text-display-sm font-semibold text-text-primary-light">Disclaimer</h2>
          <p>
          ...
          <h2 className="font-display text-display-sm font-semibold text-text-primary-light">Relationship of the Parties</h2>
          <p>
          ...
          <h2 className="font-display text-display-sm font-semibold text-text-primary-light">No Third-Party Beneficiaries</h2>
          <p>
          ...
          <h2 className="font-display text-display-sm font-semibold text-text-primary-light">Site Use</h2>
          <p>
          ...
          <h2 className="font-display text-display-sm font-semibold text-text-primary-light">Compliance</h2>
          <p>
          ...
          <h2 className="font-display text-display-sm font-semibold text-text-primary-light">Types of Accounts</h2>
          <p>
          ...
          <h2 className="font-display text-display-sm font-semibold text-text-primary-light">Confidentiality</h2>
          <p>
          ...
          <h2 className="font-display text-display-sm font-semibold text-text-primary-light">Payment Terms</h2>
          <p>
          ...
          <h2 className="font-display text-display-sm font-semibold text-text-primary-light">Refund Policy</h2>
          <p>
          ...
          <ol className="flex flex-col gap-4 pl-6 list-decimal">
            <li>
              <strong>Done-For-You (DFY) One-Time Setup Fees</strong>
              <p className="mt-1">Refunds for DFY setup services will only be granted under the following conditions:</p>
              <ul className="list-disc pl-6 flex flex-col gap-1 mt-1">
                <li><strong>Non-Functional Agent:</strong> A refund may be issued if Nova Echo is unable to deliver a functional AI agent as promised. A functional agent is defined as one that: Can hold a complete, human-like conversation; and Executes the specific promised actions. Minor or occasional issues — such as mispronunciations, tone or speed inconsistencies, or incorrect reading of names, emails, or phone numbers — do not constitute a non-functional agent and are considered within the normal range of performance for AI technology.</li>
                <li><strong>Delayed Buildout:</strong> A refund may be granted if Nova Echo fails to deliver the first version of the buildout within the expected timeline due to internal delays. However, delays caused by: Ongoing client requests for small changes or revisions; Third-party platform issues (e.g., Twilio, Go High Level, CRM access or integration problems); do not qualify for refunds.</li>
              </ul>
              <p className="mt-1">No refunds will be issued more than 30 calendar days after completion of the buildout, regardless of circumstances.</p>
            </li>
            <li>
              <strong>Done-With-You (DWY), Subscriptions, and Campaign Management Services</strong>
              <p className="mt-1">All subscriptions are cancel-anytime. You can cancel via your dashboard or by contacting <a href="mailto:support@novaecho.ai">support@novaecho.ai</a>. If a subscription is not canceled before the renewal date, the corresponding payment is non-refundable.</p>
              <p className="mt-1">Refunds for subscription plans may be considered only if: Nova Echo&apos;s platform becomes entirely unusable due to an internal issue for more than 10 consecutive days. In such cases, a partial or full refund may be issued depending on the length and extent of the downtime. Refunds will not be granted due to: User failure to cancel on time; Issues caused by third-party platforms (e.g., CRM setup, Twilio issues); Lack of campaign results or performance (as lead quality and other variables are outside our control).</p>
            </li>
            <li>
              <strong>AI Minutes and Usage-Based Charges</strong>
              <p className="mt-1">All purchases of AI minutes or usage-based services are final. These are charged on a pay-as-you-go basis and are non-refundable under all circumstances.</p>
            </li>
          </ol>
          <p><strong>Questions &amp; Support</strong></p>
          <p>
            To inquire about a potential refund under this policy, please contact: Email: <a href="mailto:support@novaecho.ai">support@novaecho.ai</a> &middot; Phone: <a href="tel:+15614751497">(561) 475-1497</a>
          </p>
          <p>Nova Echo reserves the right to evaluate all refund requests on a case-by-case basis and issue decisions in alignment with this policy and our Terms of Service.</p>

          <h2 className="font-display text-display-sm font-semibold text-text-primary-light">Fair Use Policy</h2>
          <ol className="flex flex-col gap-4 pl-6 list-decimal">
            <li><strong>Purpose.</strong> Certain subscription plans may include &quot;unlimited&quot; usage for AI voice minutes. &quot;Unlimited&quot; means the absence of fixed per-minute charges for normal and reasonable business use. This Fair Use Policy exists to ensure system reliability, prevent misuse, and maintain equitable access and cost fairness across all customers.</li>
            <li><strong>Normal and Reasonable Use.</strong> The Company&apos;s &quot;unlimited&quot; offerings are intended for ordinary business operations by a typical commercial user. Usage that falls within what ninety-five percent (95%) of active customers generate during a given billing period is considered normal and reasonable. Within this range, the Company does not meter or impose per-minute charges for &quot;unlimited&quot; plans.</li>
            <li><strong>High-Volume Usage and Notification.</strong> If a customer&apos;s aggregate usage exceeds that of approximately ninety-five percent (95%) of all active customers during any rolling thirty-day period, the Company may, at its sole discretion: Notify the customer that their usage materially exceeds typical levels; Offer the customer options to upgrade to a higher-tier plan, purchase high-volume add-ons, or enter into a custom usage agreement; and Provide reasonable time for the customer to evaluate and accept one of these options. The Company will make such contact before implementing any restriction or modification to the customer&apos;s service.</li>
            <li><strong>Dynamic Guidance.</strong> Usage thresholds and high-volume benchmarks are dynamic and determined by aggregate system data. These figures may be periodically updated to reflect changes in overall customer usage. Current guidance may be referenced within the product dashboard, documentation, or other customer communications.</li>
            <li><strong>Grace Period.</strong> To prevent service disruption, the Company provides a minimum ten percent (10%) grace buffer beyond any published or communicated high-volume guidance. During this period, the customer&apos;s service will remain active and uninterrupted. If the customer continues to materially exceed usage thresholds without upgrading or accepting a new plan after notice and grace, the Company may temporarily restrict new calls or sessions until appropriate adjustments are made.</li>
            <li><strong>Prohibited and Abusive Uses.</strong> Unlimited plans may not be used for: Mass outbound spam campaigns; Non-business, fraudulent, or unlawful activities; Activity that degrades or interferes with system performance or other customers&apos; use. The Company reserves the right to immediately suspend or terminate accounts engaged in such activity without refund or prior notice.</li>
            <li><strong>Notice and Resolution.</strong> Prior to any enforcement or restriction, the Company will make reasonable efforts to notify the customer and provide upgrade or add-on options. Existing active calls or sessions will not be interrupted mid-process. Once the customer accepts a new plan or add-on, normal service will resume automatically.</li>
          </ol>

          <h2 className="font-display text-display-sm font-semibold text-text-primary-light">Additional Fees</h2>
          <p>
          ...
          <h2 className="font-display text-display-sm font-semibold text-text-primary-light">User Registration</h2>
          <p>
          ...
          <h2 className="font-display text-display-sm font-semibold text-text-primary-light">User Representations</h2>
          <p>
          ...
          <h2 className="font-display text-display-sm font-semibold text-text-primary-light">Prohibited Activities</h2>
          <p>As a user of the Site, you agree not to:</p>
          <ul className="list-disc pl-6 flex flex-col gap-1">
            <li>Systematically retrieve data or other content from the Site to create or compile, directly or indirectly, a collection, compilation, database, or directory without our written consent.</li>
            <li>Trick, defraud, or mislead us and/or other users, especially in any attempt to learn sensitive account information such as user passwords.</li>
            ...
            <li>Upload or transmit (or attempt to upload or to transmit) any material that acts as a passive or active information collection or transmission mechanism, including without limitation, clear GIFs, 1x1 pixels, web bugs, cookies, or other similar devices.</li>
            ...
            <li>Use, launch, develop, or distribute any automated system, including without limitation, any spider, robot, cheat utility, scraper, or offline reader that accesses the Site, or using or launching any unauthorized script or other software.</li>
            <li>Use a buying or purchasing agent to make purchases on the Site.</li>
            <li>Make any unauthorized use of the Site, including collecting usernames and/or email addresses of users by electronic or other means for the purpose of sending unsolicited email, or creating user accounts by automated means or under false pretenses.</li>
          </ul>

          <h2 className="font-display text-display-sm font-semibold text-text-primary-light">User Data</h2>
          <p>
            We will maintain certain data that you transmit to the Site for the purpose of managing the performance of the Site, as well as data relating to your use of the Site. Although we perform regular routine backups of data, you are solely responsible for all data that you transmit or that relates to any activity you have undertaken using the Site. You agree that we shall have no liability to you for any loss or corruption of any such data, and you hereby waive any right of action against us arising from any such loss or corruption of such data.
          </p>

          <h2 className="font-display text-display-sm font-semibold text-text-primary-light">User-Generated Contributions</h2>
          <p>
          ...
          <ul className="list-disc pl-6 flex flex-col gap-1">
            ...
            <li>You have the necessary rights/permissions to use and authorize use of your Contributions.</li>
            <li>You have obtained written consent from identifiable individuals featured in your Contributions.</li>
            <li>Your Contributions are not false, inaccurate, or misleading.</li>
            <li>Your Contributions are not unsolicited or unauthorized advertising or solicitation.</li>
            <li>Your Contributions are not obscene, harassing, defamatory, or otherwise objectionable.</li>
            <li>Your Contributions do not ridicule or abuse anyone.</li>
            <li>Your Contributions do not advocate violence or threaten physical harm.</li>
            <li>Your Contributions do not violate any law, regulation, or rule.</li>
            <li>Your Contributions do not violate privacy or publicity rights.</li>
            <li>Your Contributions do not solicit personal information from anyone under 18 or exploit minors.</li>
            <li>Your Contributions do not violate laws concerning child protection.</li>
            <li>Your Contributions do not include offensive comments connected to protected characteristics.</li>
            <li>Your Contributions do not otherwise violate these Terms or any applicable law.</li>
          </ul>
          <p>Any use of the Site in violation of the foregoing violates these Terms of Service and may result in termination or suspension of your rights to use the Site.</p>

          <h2 className="font-display text-display-sm font-semibold text-text-primary-light">Contribution License</h2>
          <p>
          ...
          <h2 className="font-display text-display-sm font-semibold text-text-primary-light">Guidelines for Reviews</h2>
          <p>
          ...
          <h2 className="font-display text-display-sm font-semibold text-text-primary-light">Submissions</h2>
          <p>
          ...
          <h2 className="font-display text-display-sm font-semibold text-text-primary-light">Mobile Application Use License</h2>
          <p>
          ...
          <h2 className="font-display text-display-sm font-semibold text-text-primary-light">Terms for Apple and Android Devices</h2>
          <p>
          ...
          <h2 className="font-display text-display-sm font-semibold text-text-primary-light">Social Media and Third-Party Accounts</h2>
          <p>
          ...
          <h2 className="font-display text-display-sm font-semibold text-text-primary-light">Third-Party Websites and Content</h2>
          <p>
          ...
          <h2 className="font-display text-display-sm font-semibold text-text-primary-light">Third-Party Marketing Services</h2>
          <p>
          ...
          <h2 className="font-display text-display-sm font-semibold text-text-primary-light">Compensation for Recommendations of Third Parties</h2>
          <p>
          ...
          <h2 className="font-display text-display-sm font-semibold text-text-primary-light">Term and Termination</h2>
          <p>
          ...
          <h2 className="font-display text-display-sm font-semibold text-text-primary-light">Governing Law and Binding Arbitration</h2>
          <ol className="flex flex-col gap-3 pl-6 list-decimal">
            <li><strong>Governing Law:</strong> These Terms are governed by the laws of the State of Delaware, without regard to conflict of laws principles.</li>
            <li><strong>Informal Negotiations:</strong> The Parties agree to attempt to negotiate any Dispute informally for at least thirty (30) days before initiating arbitration (except as noted in subsection (g)).</li>
            <li><strong>Binding Arbitration:</strong> Except as provided in subsection (e) and applicable law, any claim shall be settled by arbitration administered by the American Arbitration Association under its commercial rules. One arbitrator, seated in Delaware; English language; Delaware law; written, final decision. We bear our costs and your reasonable outside attorneys&apos; fees actually incurred; if we prevail, we may be reimbursed for amounts expended on your behalf. Class actions and consolidations are waived. If any provision is unenforceable, the remainder is enforced.</li>
            <li><strong>Restrictions:</strong> Arbitration is limited to the Dispute between the Parties individually; no class or representative proceedings.</li>
            <li><strong>Small-Claims Option:</strong> You may elect small-claims court for a breach of warranty claim by written notice within 90 days of purchase; only for your individual dispute.</li>
            <li><strong>Time to Commence Action:</strong> No Dispute may be commenced more than one (1) year after the cause of action arose. If illegal or unenforceable, such Dispute shall be decided by a court of competent jurisdiction as designated herein.</li>
            <li><strong>Exceptions:</strong> The following Disputes are excluded from informal negotiations and arbitration: enforcement/validity of IP rights; theft, piracy, invasion of privacy, or unauthorized use; and claims for injunctive relief. If illegal or unenforceable, such Disputes proceed in court as designated herein.</li>
          </ol>

          <h2 className="font-display text-display-sm font-semibold text-text-primary-light">Limitations of Liability</h2>
          <p>
          ...
          <h2 className="font-display text-display-sm font-semibold text-text-primary-light">Indemnification</h2>
          <p>
          ...
          <h2 className="font-display text-display-sm font-semibold text-text-primary-light">No Legal, Tax, Financial, or Other Advice Provided</h2>
          <p>
          ...
          <h2 className="font-display text-display-sm font-semibold text-text-primary-light">Electronic Communications, Transactions, and Signatures</h2>
          <p>
          ...
          <h2 className="font-display text-display-sm font-semibold text-text-primary-light">Force Majeure</h2>
          <p>
          ...
          <h2 className="font-display text-display-sm font-semibold text-text-primary-light">Assignment</h2>
          <p>
          ...
          <h2 className="font-display text-display-sm font-semibold text-text-primary-light">Partial Invalidity</h2>
          <p>
          ...
          <h2 className="font-display text-display-sm font-semibold text-text-primary-light">No Waivers</h2>
          <p>
            Our failure to enforce any right does not constitute a waiver of future enforcement, subject to applicable law.
          </p>

          <h2 className="font-display text-display-sm font-semibold text-text-primary-light">Entire Agreement</h2>
          <p>
            These Terms constitute the entire agreement between you and Nova Echo and govern your use of the Site, superseding all prior communications and proposals. You may also be subject to additional terms and posted policies (including the <a href="/privacy">Privacy Policy</a>). Nova Echo may revise these Terms at any time by posting updates on the Site. Your continued use after changes signifies acceptance.
          </p>

          <div className="mt-2 border-t border-surface-200 pt-6 text-caption text-text-secondary-light/60 flex flex-col gap-1">
            <p>Terms of Service</p>
            <p>Effective Date: March 21, 2024</p>
            <p>Contact: <a href="mailto:support@novaecho.ai">support@novaecho.ai</a> &middot; <a href="tel:+15614751497">(561) 475-1497</a></p>
          </div>
        </div>
      </div>
    </section>
